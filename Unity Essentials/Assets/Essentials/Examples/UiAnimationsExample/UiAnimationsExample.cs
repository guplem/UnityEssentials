...
public class UiAnimationsExample : MonoBehaviour
{
    ...
    private RectTransformAnimation codeAnimation = null;
    
    void Start()
    {
        codeAnimation = new RectTransformAnimation(GetComponent<RectTransform>(), destination, origin, 1f, Curve.Linear);
